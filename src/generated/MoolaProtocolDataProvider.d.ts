...
interface MoolaProtocolDataProviderInterface extends ethers.utils.Interface {
  functions: {
...
export class MoolaProtocolDataProvider extends BaseContract {
  ...
  interface: MoolaProtocolDataProviderInterface;
