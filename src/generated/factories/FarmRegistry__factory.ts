...
export class FarmRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): FarmRegistryInterface {
    return new utils.Interface(_abi) as FarmRegistryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): FarmRegistry {
    return new Contract(address, _abi, signerOrProvider) as FarmRegistry;
  }
}
